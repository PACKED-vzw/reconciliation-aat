...
if(isset($_REQUEST['service'])&&$_REQUEST['service']=="odis")
{
    $service = new OdisService();
}
elseif(isset($_REQUEST['service'])&&$_REQUEST['service']=="rkd"){
    $service = new RkdService();
}
elseif(isset($_REQUEST['service'])&&$_REQUEST['service']=="aat"){
